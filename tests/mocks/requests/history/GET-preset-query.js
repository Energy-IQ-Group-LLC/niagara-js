...
export const getPresetQueryResponse = xml2js(responseData, { compact: true });
export const getInitialPresetQueryResponse = xml2js(initialResponseData, { compact: true });
